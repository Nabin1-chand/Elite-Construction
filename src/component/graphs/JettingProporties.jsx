    ...
    <VStack align="stretch" spacing={2} flex="1">
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis
              ...
              dataKey="val"
              axisLine={false}
              tick={{ fontSize: 10, fill: '#7c880d', fontWeight: 'bold' }} // Highlight X-axis ticks
              label={{
                value: 'Value',
            ...
            <YAxis
              ...
              axisLine={false}
              tickLine={false}
              tick={{ fontSize: 11, fontWeight: 'bold', fill: '#0b3358' }} // Highlight Y-axis ticks
              label={
                showYAxis
                  ? { value: 'Depth (m)', angle: -90, position: 'insideLeft', offset: 10 }
                  : null
              }
              domain={[1, 11]}
            />
            ...
            {spec && (
              <ReferenceArea x1={spec.min} x2={spec.max} fill="#dcfce7" fillOpacity={0.7} />
            )}
      ...
      <Center>
        <Box
          ...
          bg="blue.50"
        >
          <Text fontSize="10px" color="blue.800" fontWeight="bold">
            Avg: {avg}
          </Text>
        </Box>
      </Center>
